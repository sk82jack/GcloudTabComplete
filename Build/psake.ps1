...
Task BuildDocs -depends Build {
    ...
    $Params = @{
        ...
        LinkMode       = 'Automatic'
        LinkPattern    = @{
            FirstRelease  = "https://github.com/sk82jack/$ENV:BHProjectName/tree/{CUR}"
            NormalRelease = "https://github.com/sk82jack/$ENV:BHProjectName/compare/{PREV}..{CUR}"
            Unreleased    = "https://github.com/sk82jack/$ENV:BHProjectName/compare/{CUR}..HEAD"
        }
    }
